...
static const variant_info_t veux_info = {
    ...
    .model = "2201116SC",
    .name = "veux",
    .build_fingerprint = "Redmi/veux/veux:13/TKQ1.221114.001/V816.0.1.0.TKCCNXM:user/release-keys",
...
static const variant_info_t veux_jp_info = {
    ...
    .model = "2201116SR",
    .name = "veux_jp",
    .build_fingerprint = "Redmi/veux_jp/veux:13/TKQ1.221114.001/V14.0.4.0.TKCJPXM:user/release-keys",
